...
class IngredientControllerTest {
    ...
    void ShowIngredient() throws Exception {
        ...
        when(mockIngredientService.findByRecipeIDAndIngredientId(testIdStr,testIngredientIdStr)).thenReturn(monoIngredientCommand);
    ...
    void updateIngredient() throws Exception {
        ...
        Mono<IngredientCommand> mockSavedIngredientMono =  Mono.just(mockSavedIngredient);

        when(mockIngredientService.saveIngredient(any(IngredientCommand.class))).thenReturn(mockSavedIngredientMono);
